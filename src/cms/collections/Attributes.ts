...
/**
 * Из чего складывается событие: билеты, гид, отель, трансфер. Один справочник на
 * состав события и на удобства номера — отсюда множественный `scope`: «Отель» и
